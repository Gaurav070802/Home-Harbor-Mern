  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <img onClick={() => fileRef.current.click()} src={formData.avatar || (currentUser && currentUser.avatar)} alt="profile" className="rounded-full h-24 w-24 object-cover cursor-pointer self-center mt-2" />
      ...
      {userListings && 
        ...
        <div className="flex flex-col gap-4">
          <h1 className="text-cennter mt-7 text-2xl font-semibold ">Your listings</h1>
